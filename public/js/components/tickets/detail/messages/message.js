...
const TicketMessage = React.createClass({
    ...
    render() {
        return (
            <div>
                {this.props.ticket ? this.props.ticket.messages.map((m, i) => <Message our={m.author.email !== this.props.ticket.author.email} key={i} message={m} />) : ''}
            </div>
        )
    }
});
            ...
            <div>
                <div className={this.props.our ? "message our" : "message"}>
                    ...
                    <div className="author">
                        ...
                        <a className="email" href="javascript:void(0)">&lt;{message.author.email}&gt;</a>
